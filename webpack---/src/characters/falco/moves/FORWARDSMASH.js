  ...
  main: function main(p, input) {
    ...
    if (!this.interrupt(p, input)) {
      ...
      if (_main.player[p].timer < 9) {
        ...
        _main.player[p].phys.cVel.x = 1.54 * _main.player[p].phys.face;
      } else if (_main.player[p].timer < 31) {
        _main.player[p].phys.cVel.x = 1.14 * _main.player[p].phys.face;
      } else {
        _main.player[p].phys.cVel.x = 0;
      }
      ...
      if (_main.player[p].timer > 12 && _main.player[p].timer < 22) {
...
//////////////////
// WEBPACK FOOTER
// ./src/characters/falco/moves/FORWARDSMASH.js
// module id = 562
// module chunks = 1
//# sourceURL=webpack:///./src/characters/falco/moves/FORWARDSMASH.js?