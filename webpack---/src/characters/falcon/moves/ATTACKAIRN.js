...
exports.default = {
  ...
  main: function main(p, input) {
    ...
    if (!this.interrupt(p, input)) {
      ...
      if (_main.player[p].timer > 7 && _main.player[p].timer < 13) {
      ...
      if (_main.player[p].timer > 20 && _main.player[p].timer < 30) {
...
//////////////////
// WEBPACK FOOTER
// ./src/characters/falcon/moves/ATTACKAIRN.js
// module id = 642
// module chunks = 1
//# sourceURL=webpack:///./src/characters/falcon/moves/ATTACKAIRN.js?