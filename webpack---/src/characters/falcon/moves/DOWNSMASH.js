...
exports.default = {
  ...
  main: function main(p, input) {
    ...
    if (!this.interrupt(p, input)) {
      ...
      if (_main.player[p].timer > 19 && _main.player[p].timer < 23) {
      ...
      if (_main.player[p].timer > 29 && _main.player[p].timer < 33) {
        _main.player[p].hitboxes.frame++;
      }
  ...
  interrupt: function interrupt(p, input) {
    if (_main.player[p].timer > 49) {
      ...
      return true;
    } else if (_main.player[p].timer > 44 && !_main.player[p].inCSS) {
...
//////////////////
// WEBPACK FOOTER
// ./src/characters/falcon/moves/DOWNSMASH.js
// module id = 637
// module chunks = 1
//# sourceURL=webpack:///./src/characters/falcon/moves/DOWNSMASH.js?