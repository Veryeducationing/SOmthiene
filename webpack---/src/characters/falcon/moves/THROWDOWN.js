...
exports.default = {
  ...
  init: function init(p, input) {
    ...
    _actionStateShortcuts.actionStates[_main.characterSelections[grabbing]].THROWNFALCONDOWN.init(grabbing);
    var frame = _characters.framesData[_main.characterSelections[grabbing]].THROWNFALCONDOWN;
  ...
  main: function main(p, input) {
    ...
    _main.player[p].timer += 16 / _main.player[p].phys.releaseFrame;
    if (!this.interrupt(p, input)) {
      if (Math.floor(_main.player[p].timer + 0.01) >= 16 && Math.floor(prevFrame + 0.01) < 16) {
        _main.player[p].hitboxes.id[0] = _main.player[p].charHitboxes.throwdown.id0;
...
//////////////////
// WEBPACK FOOTER
// ./src/characters/falcon/moves/THROWDOWN.js
// module id = 662
// module chunks = 1
//# sourceURL=webpack:///./src/characters/falcon/moves/THROWDOWN.js?