...
exports.default = {
  ...
  init: function init(p, input) {
    ...
    _main.player[p].hitboxes.id[2] = _main.player[p].charHitboxes.upsmash1.id2;
    _main.player[p].hitboxes.id[3] = _main.player[p].charHitboxes.upsmash1.id3;
  ...
  main: function main(p, input) {
    ...
    if (!this.interrupt(p, input)) {
      ...
      if (_main.player[p].timer > 21 && _main.player[p].timer < 23) {
      ...
      if (_main.player[p].timer === 27) {
        ...
        _main.player[p].hitboxes.id[2] = _main.player[p].charHitboxes.upsmash2.id2;
        _main.player[p].hitboxes.frame = 0;
...
//////////////////
// WEBPACK FOOTER
// ./src/characters/falcon/moves/UPSMASH.js
// module id = 636
// module chunks = 1
//# sourceURL=webpack:///./src/characters/falcon/moves/UPSMASH.js?