...
exports.default = {
  ...
  init: function init(p, input) {
    ...
    _actionStateShortcuts.actionStates[_main.characterSelections[grabbing]].THROWNMARTHBACK.init(grabbing, input);
    ...
    var frame = _characters.framesData[_main.characterSelections[grabbing]].THROWNMARTHBACK;
  ...
  interrupt: function interrupt(p, input) {
    if (_main.player[p].timer > 39) {
      ...
      if (_main.player[p].timer < 7 && _main.player[grabbing].phys.grabbedBy !== p) {
...
//////////////////
// WEBPACK FOOTER
// ./src/characters/marth/moves/THROWBACK.js
// module id = 406
// module chunks = 1
//# sourceURL=webpack:///./src/characters/marth/moves/THROWBACK.js?