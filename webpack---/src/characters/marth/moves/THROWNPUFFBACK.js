...
exports.default = {
  ...
  init: function init(p, input) {
    ...
    _index2.default.THROWNPUFFBACK.main(p, input);
  },
  main: function main(p, input) {
    _main.player[p].timer++;
    if (!_index2.default.THROWNPUFFBACK.interrupt(p, input)) {
      ...
      if (timer > 0) {
        ...
        if (timer > _index2.default.THROWNPUFFBACK.offset.length) {
          timer = _index2.default.THROWNPUFFBACK.offset.length - 1;
        }
        _main.player[p].phys.pos = new _Vec2D.Vec2D(_main.player[grabbedBy].phys.pos.x + _index2.default.THROWNPUFFBACK.offset[timer - 1][0] * _main.player[p].phys.face * -1, _main.player[grabbedBy].phys.pos.y + _index2.default.THROWNPUFFBACK.offset[timer - 1][1]);
...
//////////////////
// WEBPACK FOOTER
// ./src/characters/marth/moves/THROWNPUFFBACK.js
// module id = 417
// module chunks = 1
//# sourceURL=webpack:///./src/characters/marth/moves/THROWNPUFFBACK.js?