...
exports.default = {
  ...
  init: function init(p, input) {
    ...
    _actionStateShortcuts.actionStates[_main.characterSelections[grabbing]].THROWNPUFFFORWARD.init(grabbing, input);
    var frame = _characters.framesData[_main.characterSelections[grabbing]].THROWNPUFFFORWARD;
  ...
  main: function main(p, input) {
    ...
    if (!_index2.default.THROWFORWARD.interrupt(p, input)) {
      if (Math.floor(_main.player[p].timer + 0.01) >= 12 && prevFrame < 12) {
...
//////////////////
// WEBPACK FOOTER
// ./src/characters/puff/moves/THROWFORWARD.js
// module id = 328
// module chunks = 1
//# sourceURL=webpack:///./src/characters/puff/moves/THROWFORWARD.js?