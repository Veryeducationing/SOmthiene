...
exports.default = {
  ...
  init: function init(p, input) {
    ...
    _actionStateShortcuts.actionStates[_main.characterSelections[grabbing]].THROWNPUFFUP.init(grabbing, input);
    (0, _actionStateShortcuts.turnOffHitboxes)(p);
    var frame = _characters.framesData[_main.characterSelections[grabbing]].THROWNPUFFUP;
  ...
  main: function main(p, input) {
    ...
    if (!_index2.default.THROWUP.interrupt(p, input)) {
      if (Math.floor(_main.player[p].timer + 0.01) >= 7 && prevFrame < 7) {
...
//////////////////
// WEBPACK FOOTER
// ./src/characters/puff/moves/THROWUP.js
// module id = 341
// module chunks = 1
//# sourceURL=webpack:///./src/characters/puff/moves/THROWUP.js?